...
export default function Plane() {
    return (
        <>
            <div
                class="text-indigo-950 text-center text-8xl font-semibold leading-[100.32px] capitalize self-center mt-28 max-md:max-w-full max-md:text-4xl"
            >
                chose your
            </div>
            <div
            ...
            >
                <div class="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                        ...
                        >
                            <img alt=""
                                ...
                                srcset="https://cdn.builder.io/api/v1/image/assets/TEMP/8c2882fb6b55e004dd7de796f4a29aadce86793e0ecb9b2c2d4307499f4dd964?apiKey=c2a9b141e86b4f86b11cebb14749f34c&width=100 100w,
                                        ...
                                        https://cdn.builder.io/api/v1/image/assets/TEMP/8c2882fb6b55e004dd7de796f4a29aadce86793e0ecb9b2c2d4307499f4dd964?apiKey=c2a9b141e86b4f86b11cebb14749f34c&width=400 400w,
                                        https://cdn.builder.io/api/v1/image/assets/TEMP/8c2882fb6b55e004dd7de796f4a29aadce86793e0ecb9b2c2d4307499f4dd964?apiKey=c2a9b141e86b4f86b11cebb14749f34c&width=800 800w,
                                        https://cdn.builder.io/api/v1/image/assets/TEMP/8c2882fb6b55e004dd7de796f4a29aadce86793e0ecb9b2c2d4307499f4dd964?apiKey=c2a9b141e86b4f86b11cebb14749f34c&width=1200 1200w,
                            ...
                            >
                                ...
                                <div
                                    class="text-white text-sm font-medium uppercase whitespace-nowrap shadow-sm self-center justify-center items-stretch mt-3.5 px-5 py-5 rounded-[100px_18px]"
                                >
                                    16 Tours
                                </div>
                            </div>
                    ...
                    >
                        <div
                            class="flex grow flex-col items-stretch max-md:max-w-full max-md:mt-5"
                        >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div
                                                class="relative text-white text-sm font-medium uppercase whitespace-nowrap shadow-sm justify-center items-stretch mt-2 mb-11 px-5 py-5 rounded-2xl max-md:mb-10"
                                            >
                                                16 Tours
                                            </div>
                                        </div>
            ...
            <div
                class="text-teal-400 text-base font-bold tracking-[3.2px] uppercase self-center whitespace-nowrap mt-24 max-md:mt-10"
            >
                Testimonial
            </div>
            <div
                class="text-slate-800 text-center text-5xl font-bold self-center max-w-[591px] mt-1 max-md:max-w-full max-md:text-4xl"
            >
